    ...
    var Iti = /*#__PURE__*/ (function () {
      ...
      _createClass(Iti, [
        ...
        },
        {
          ...
          value: function _generateMarkup() {
            ...
            var showFlagsContainer =
              allowDropdown || showFlags || showSelectedDialCode;
            ...
            if (allowDropdown) {
              ...
              var extraClasses = fixDropdownWidth
                ? ""
              ...
              if (countrySearch) {
                this.searchInput = this._createEl(
                  "input",
                  {
                    ...
                    placeholder:
                      this.options.i18n.searchPlaceholder || "Search",
                  },
              ...
              this.countryList = this._createEl(
                "ul",
                {
                  ...
                  role: "listbox",
                  "aria-label":
                    this.options.i18n.countryListAriaLabel ||
                    "List of countries",
                },
                this.dropdownContent
              );
        ...
        },
        {
          ...
          value: function _appendListItems(countries, className, preferred) {
            for (var i = 0; i < countries.length; i++) {
              ...
              content += "<span class='iti__country-name'>".concat(
                c.name,
                "</span>"
              );
              content += "<span class='iti__dial-code'>+".concat(
                c.dialCode,
                "</span>"
              );
        ...
        },
        {
          ...
          value: function _setInitialState() {
            ...
            if (dialCode && !isRegionlessNanp) {
              ...
              var isValidInitialCountry =
                initialCountry &&
                this._getCountryData(initialCountry, false, true);
        ...
        },
        {
          ...
          value: function _initDropdownListeners() {
            ...
            this._handleClickSelectedFlag = function () {
              ...
              if (
                _this3.dropdownContent.classList.contains("iti__hide") &&
                !_this3.telInput.disabled &&
                !_this3.telInput.readOnly
              ) {
          ...
          value: function _initKeyListeners() {
            ...
            this._handleKeyEvent = function (e) {
              ...
              if (_this5.options.formatAsYouType && !userOverrideFormatting) {
                ...
                var valueBeforeCaret = _this5.telInput.value.substring(
                  0,
                  currentCaretPos
                );
                var relevantCharsBeforeCaret = valueBeforeCaret.replace(
                  /[^+0-9]/g,
                  ""
                ).length;
                var isDeleteForwards =
                  e && e.inputType === "deleteContentForward";
                var formattedValue = _this5._formatNumberAsYouType();
                var newCaretPos = _this5._translateCursorPosition(
        ...
        },
        {
          ...
          value: function _translateCursorPosition(
            relevantChars,
            formattedValue,
            prevCaretPos,
            isDeleteForwards
        ...
        },
        {
          ...
          value: function _setDropdownPosition() {
            ...
            if (!this.options.useFullscreenPopup) {
              ...
              var positionDropdownAboveInput =
                !this.options.countrySearch &&
                !dropdownFitsBelow &&
                dropdownFitsAbove;
              ...
              if (this.options.dropdownContainer) {
                ...
                var extraTop = positionDropdownAboveInput
                  ? 0
        ...
        },
        {
          ...
          value: function _formatNumberAsYouType() {
            ...
            var result = window.intlTelInputUtils
            ...
            if (
              ...
              result.includes("+".concat(dialCode))
            ) {
